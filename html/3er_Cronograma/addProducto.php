		                ...
		                <div class="row">
		                    <div class="col-sm-8 col-sm-offset-2" data-form-type="formoid">
		                        <div class="mbr-header mbr-header--center mbr-header--std-padding">
		                            <h2 class="mbr-header__text">AGREGAR PRODUCTO A LA COTIZACIÓN <?php echo $_cotizacion3er[$_GET['id']]['cotizacion'];?> del 3er Cronograma</h2>
		                        </div>
		                        <p>Los campos con (*) son obligatorios.</p>
		                        <form class="form-horizontal" method="POST" action="?view=3erCronograma&mode=addProducto&id=<?php echo $_GET['id'];?>">
