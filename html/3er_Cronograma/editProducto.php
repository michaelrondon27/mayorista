		                ...
		                <div class="row">
		                    <div class="col-sm-8 col-sm-offset-2" data-form-type="formoid">
		                        <div class="mbr-header mbr-header--center mbr-header--std-padding">
		                            <h2 class="mbr-header__text">EDITAR PRODUCTO A LA COTIZACIÓN <?php echo $_cotizacion3er[$_GET['id']]['cotizacion'];?> del 3er Cronograma</h2>
		                        </div>
		                        <p>Los campos con (*) son obligatorios.</p>
		                        <form class="form-horizontal" method="POST" action="?view=3erCronograma&mode=editProducto&id=<?php echo $_GET['id'];?>&orden=<?php echo $_GET['orden'];?>">
		                       		<?php
		                       			$orden=$_GET['orden'];
										$sql=$db->query("SELECT id_almacenadora, id_producto, id_modelo, cantidad, precio_num FROM ordenes WHERE id_ordenes=$orden LIMIT 1;");
									    ...
									    <div class="col-sm-8">
											<select class="form-control" id="alma1" name="alma1">
												<option value="">Seleccione</option>
											   	<?php
											   		foreach ($_almacenadoras3er as $almacenadoras) {
											   			?>
									...
									<div class="form-group">
									    ...
									    <div class="col-sm-8">
											<select class="form-control" id="prod1" name="prod1">
												<option value="">Seleccione</option>
											   	<?php
											   		foreach ($_producto3er as $producto) {
												   		?>
