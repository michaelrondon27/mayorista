...
<body class="fondo">
		<div class="container" style="margin-left: 180px; padding-top: 40px;">
			<br>
			<div class="col-md-2">
				<a class="btn btn-danger" href="?view=4toCronograma&mode=allCotizacion"><i class="fa fa-reply" aria-hidden="true"></i> Ir a Consulta de Cotizaciones</a>
			</div>
			<h4 class="col-md-12" align="center">COTIZACI&Oacute;N 4to Cronograma</h4>
			<form class="form-horizontal" method="post" action="?view=4toCronograma&mode=addCotizacion" id="form_cotizacion">
