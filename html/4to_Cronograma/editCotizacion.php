...
<script>
	$(document).ready(function(){
		...
		$('#productos').change(function(){
			...
			$.ajax({
	            type: "POST",
	            url: "html/4to_Cronograma/CantProd.php",
	            data:{
	            	"productos":producto
	            },
		        ...
		        <div class="row">
		            <div class="col-sm-8 col-sm-offset-2" data-form-type="formoid">
		                ...
		                <div class="mbr-header mbr-header--center mbr-header--std-padding">
		                    <h2 class="mbr-header__text">EDITAR COTIZACIÓN <?php echo $_cotizacion4to[$_GET['id']]['cotizacion'];?> del 4to Cronograma</h2>
		                </div>
		                <form method="post" action="?view=4toCronograma&mode=editCotizacion&id=<?php echo $_GET['id'];?>" id="form_cotizacion">
							<div class="form-group col-sm-12">
								<div class="col-sm-3">
									<label for="cotizacion" class="control-label"><strong>Cotizaci&oacute;n Nro.:</strong></label>
							    </div>
							    <div class="col-sm-3">
							      <input type="text" class="form-control" id="cotizacion" name="cotizacion" value="<?php echo $_cotizacion4to[$_GET['id']]['cotizacion'];?>" required>
							    </div>
								<label class="col-sm-3 control-label">
									<strong>Fecha: </strong>
								</label>
								<div class="col-sm-3">
							      <input type="text" class="form-control" id="datepicker" name="fecha" value="<?php echo $fec=date("d-m-Y", strtotime($_cotizacion4to[$_GET['id']]['fecha']));?>" autocomplete="off" required>
							    </div>
							</div>
							<div class="form-group col-sm-12">
									...
									<select class="form-control" name="empresa">
											...
											<?php
												foreach ($_beneficiario as $beneficiario) {
													if($beneficiario['id_empresa']==$_cotizacion4to[$_GET['id']]['id_empresa']){
														?>
			            ...
			            <div class="col-md-2">
							<a class="btn btn-danger" href="?view=4toCronograma&mode=addProducto&id=<?php echo $_GET['id'];?>">Agregar Producto</a>
						</div>
						<div class="col-md-2">
							<a class="btn btn-danger" href="?view=4toCronograma&mode=addDescuento&id=<?php echo $_GET['id'];?>">Agregar o Editar Descuento</a>
						</div>
						<div class="form-group">
				            <table class="table table-bordered" id="mitabla">
								...
								<?php 
									$id=$_GET['id']; 
									$sql=$db->query("SELECT o.id_ordenes, o.cantidad, o.precio_total, a.nombre, p.producto, m.modelo FROM ordenes_4to o INNER JOIN almacenadoras_4to a ON o.id_almacenadora=a.id_almacenadora INNER JOIN productos_4to p ON o.id_producto=p.id_producto INNER JOIN modelo_4to m ON o.id_modelo=m.id_modelo WHERE o.id_cotizacion=$id;");
									$contador=1;
									if($db->rows($sql)){
