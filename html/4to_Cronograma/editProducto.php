		                ...
		                <div class="row">
		                    <div class="col-sm-8 col-sm-offset-2" data-form-type="formoid">
		                        <div class="mbr-header mbr-header--center mbr-header--std-padding">
		                            <h2 class="mbr-header__text">EDITAR PRODUCTO A LA COTIZACIÓN <?php echo $_cotizacion4to[$_GET['id']]['cotizacion'];?> del 4to Cronograma</h2>
		                        </div>
		                        <p>Los campos con (*) son obligatorios.</p>
		                        <form class="form-horizontal" method="POST" action="?view=4toCronograma&mode=editProducto&id=<?php echo $_GET['id'];?>&orden=<?php echo $_GET['orden'];?>">
		                       		<?php
		                       			$orden=$_GET['orden'];
										$sql=$db->query("SELECT id_almacenadora, id_producto, id_modelo, cantidad, precio_num FROM ordenes_4to WHERE id_ordenes=$orden LIMIT 1;");
