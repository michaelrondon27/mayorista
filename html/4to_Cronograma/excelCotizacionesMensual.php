<?php
	...
	$evento="reporte excel de cotizacion 4to por fecha desde ".$_POST['desde']." hasta".$_POST['hasta'];
	...
	$sql=$db->query("SELECT c.cotizacion, c.fecha, c.total, c.total_num, e.nombre, c.unidades_total FROM cotizacion_4to c INNER JOIN empresa e ON c.id_empresa=e.id_empresa WHERE c.fecha BETWEEN '$desde' AND '$hasta' ORDER BY c.fecha;");
	$cantidad=0;
	$total=0;
